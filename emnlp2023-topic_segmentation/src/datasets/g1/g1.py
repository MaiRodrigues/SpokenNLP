...
class G1ForDocumentSegmentation(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
        DocumentSegmentationConfig(name="G1ForDocumentSegmentation", version=version, description=desc),
    ]
