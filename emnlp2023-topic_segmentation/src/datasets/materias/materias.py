...
class MateriasForDocumentSegmentation(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
        DocumentSegmentationConfig(name="MateriasForDocumentSegmentation", version=version, description=desc),
    ]
