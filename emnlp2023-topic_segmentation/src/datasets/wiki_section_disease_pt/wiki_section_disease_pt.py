...
class WikiSectionDiseasePtForDocumentSegmentation(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
        DocumentSegmentationConfig(name="WikiSectionDiseasePtForDocumentSegmentation", version=version, description=desc),
    ]
