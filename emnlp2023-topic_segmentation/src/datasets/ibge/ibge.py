...
class IBGEForDocumentSegmentation(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
        DocumentSegmentationConfig(name="IBGEForDocumentSegmentation", version=version, description=desc),
    ]
